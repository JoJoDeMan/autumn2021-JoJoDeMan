...
Maybe next time write down what you are doing before each line, makes things a bit more clear.

The library: (e1071) was taken away from all the other libraries.
On line 41 Rick removed de "=" sign so rstudio gave an error
Line 65 an arrow was taken away
The 10 was taken away on line 87 (supposed to be 1:10)